...
public class PhaseGradientQualityTest {
    @Test public void test_wrap()
    {
        ...
        float[][] wrap_result = M_quality.calculate(wrap, 0, 0);
        assertTrue(wrap_result[0][1] < wrap_result[0][4], "The phase gradient "
            + "should wrap values when calculating the gradient.  The actual "
            + "value for the larger change was " + wrap_result[0][1]
    ...
    @Test public void test_nothing()
    {
        ...
        float[][] nothing_result = M_quality.calculate(nothing, 0, 0);
    ...
    @Test public void test_all()
    {
        ...
        float[][] all_result = M_quality.calculate(all, 0, 0);
    ...
    @Test public void test_ramp()
    {
        ...
        float[][] ramp_result     = M_quality.calculate(ramp, 0, 0);
        float[][] big_ramp_result = M_quality.calculate(big_ramp, 0, 0);
    ...
    @Test public void test_crazy()
    {
        ...
        float[][] crazy_result = M_quality.calculate(crazy, 0, 0);
    ...
    private static Quality get_quality()
    {
        Quality result = new PhaseGradientQuality();
        result.set_phase_value(10);
        return result;
    }
    private Quality M_quality = get_quality();
}
