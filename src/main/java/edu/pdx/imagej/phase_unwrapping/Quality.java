...
public interface Quality extends ImageJPlugin, Prioritized {
     ...
     *
     * @param phaseValue The pixel phase value that is for the images passed in
     *                    to {@link calculate}.
     */
    default void setPhaseValue(float phaseValue) {}
     ...
     * functions {@link getTs} and {@link getZs} say how many time values and
     ...
     *
     * @param phaseImage The current phase image being unwrapped, as a float
     *                    array.
     ...
     */
    float[][]    calculate(float[][] phaseImage, int t, int z);
